...
@section('content')
    ...
    <button value="copy" onclick="copyFunction('xampp', 'xamppButton')" id="xamppButton" type="button" class="btn btn-block btn-info">
        <i class="fas fa-copy"></i> &nbsp; Copy
    </button>

    <p>2. Composer install</p>
    <input type="text" readonly value="https://getcomposer.org/Composer-Setup.exe" name="" id="composer">
    <button value="copy" onclick="copyFunction('composer', 'composerButton')" id="composerButton" type="button" class="btn btn-block btn-info">
        <i class="fas fa-copy"></i> &nbsp; Copy
    </button>

    <p>3. Git Bash install</p>
    <input type="text" readonly value="https://git-scm.com/downloads" name="" id="gitbash">
    <button value="copy" onclick="copyFunction('gitbash', 'gitbashButton')" id="gitbashButton" type="button" class="btn btn-block btn-info">
        <i class="fas fa-copy"></i> &nbsp; Copy
    </button>
    ...
    <input type="text" readonly value="https://www.stanleyulili.com/git/how-to-install-git-bash-on-windows/" name=""
        id="gitbash_install">
    <button value="copy" onclick="copyFunction('gitbash_install', 'gitbash_installButton')" id="gitbash_installButton" type="button" class="btn btn-block btn-info">
        <i class="fas fa-copy"></i> &nbsp; Copy
    </button>
    ...
    <button value="copy" onclick="copyFunction('editor_download', 'editor_downloadButton')" id="editor_downloadButton" type="button" class="btn btn-block btn-info">
        <i class="fas fa-copy"></i> &nbsp; Copy
    </button>
