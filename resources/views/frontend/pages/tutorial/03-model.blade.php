...
@section('content')
    ...
    <button value="copy" onclick="copyFunction('createModelWithMigration', 'createModelWithMigrationButton')" id="createModelWithMigrationButton" type="button" class="btn btn-block btn-info">
    ...
    <button value="copy" onclick="copyFunction('creatUserDetailsModel', 'creatUserDetailsModelButton')" id="creatUserDetailsModelButton" type="button" class="btn btn-block btn-info">
        <i class="fas fa-copy"></i> &nbsp; Copy
    </button>
    <pre>
        <code class="javascript">
